...
using System.Linq;
using Ozym.EntityModel.Validation;
using System.Xml;
using Ozym.Configuration;

namespace Ozym.Test.EntityModelService.Validation
{
    [TestClass]
    [TestCategory("Unit")]
    public class XmlValidatorTest
    {
        private const string TestXmlSchemaDefitintion = 
            "Ozym.EntityModel.Metadata.ReportStyleSheet.xsd";
