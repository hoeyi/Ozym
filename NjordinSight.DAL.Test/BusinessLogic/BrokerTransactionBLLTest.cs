...
namespace NjordinSight.Test.BusinessLogic
{
    ...
    {
        private static readonly List<BrokerTransactionCodeDto> _exampleTransactionCodes = new()
        {
            new()
            {
        ...
        private static readonly AccountDto _exampleAccount = new()
        {
            Id = -1
        };
        ...
        [TestMethod]
        public void PostAllocation_AgainstTwoLots_Returns_Completed_TransactionUpdateStatus()
        {
            // Create test instance. Both BrokerTransaction records will have the same
            // AccountId, SecurityId, and TransactionId of the opening action must match 
            // the TaxLotId of the closing action. Quantity opened is greater than quantity closed.
        ...
        /// <summary>
        /// Gets a new sample instance of the <see cref="BrokerTransactionDto"/> class, representing 
        /// a transaction that creates a tax-lot from a prior purchase or acquisition, i.e., 
        /// TradeDate != AcquisitionDate.
        /// </summary>
        private static BrokerTransactionDto SampleTransaction_QuantityEffect_IsAboveZero => 
            new()
            {
                AccountId = -1,
                SecurityId = -1,
        ...
        /// </summary>
        private static BrokerTransactionDto SampleTransaction_QuantityEffect_IsAboveZero_FromTradeDate 
            => new()
            {
                AccountId = -1,
                SecurityId = -1,
        ...
        /// </summary>
        private static BrokerTransactionDto SampleTransaction_QuantityEffect_IsZero => 
            new()
            {
                AccountId = -1,
                SecurityId = -1,
        ...
        /// </summary>
        private static BrokerTransactionDto SampleTransaction_QuantityEffect_IsBelowZero => 
            new()
            {
                AccountId = -1,
                SecurityId = -1,
