...
namespace NjordFinance.Migrations
{
    ...
    [Migration("20220430214717_FinanceDbContext_Initialize")]
    partial class FinanceDbContext_Initialize
    {
            ...
            modelBuilder.Entity("NjordFinance.Model.SecuritySymbol", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SymbolId = -100,
                            EffectiveDate = new DateTime(2000, 1, 19, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7259),
                            SecurityId = -100,
                            SymbolTypeId = -40,
                            Ticker = "MSFT"
                        },
                        ...
                        {
                            SymbolId = -101,
                            EffectiveDate = new DateTime(2003, 1, 19, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7302),
                            SecurityId = -101,
                            SymbolTypeId = -40,
                            Ticker = "AAPL"
                        },
                        ...
                        {
                            SymbolId = -102,
                            EffectiveDate = new DateTime(2006, 1, 6, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7323),
                            SecurityId = -102,
                            SymbolTypeId = -40,
                            Ticker = "JPM"
                        },
                        new
                        {
                            SymbolId = -103,
                            CustomSymbol = "BTC",
                            EffectiveDate = new DateTime(2015, 4, 10, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7329),
                            SecurityId = -103,
                            SymbolTypeId = -20
                        },
                        new
                        {
                            SymbolId = -104,
                            CustomSymbol = "LTC",
                            EffectiveDate = new DateTime(2014, 7, 29, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7334),
                            SecurityId = -104,
                            SymbolTypeId = -20
                        },
                        new
                        {
                            SymbolId = -105,
                            CustomSymbol = "ETH",
                            EffectiveDate = new DateTime(2003, 7, 5, 17, 47, 17, 12, DateTimeKind.Local).AddTicks(7339),
                            SecurityId = -105,
                            SymbolTypeId = -20
                        });
                });
