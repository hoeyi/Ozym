...
namespace NjordFinance.DataTransfer
{
    public class SecurityDto
    {
        ...
        private readonly SecurityAttributeDto _attributeViewModel;

        public SecurityDto(Security sourceModel)
        {
            _security = sourceModel;
            _attributeViewModel = new(sourceModel);
        }

        public SecurityAttributeDto AttributeViewModel => _attributeViewModel;
