...
{
    /// <summary>
    /// Extension-method class for seeding the initial reference data used by the application.
    /// All migrations include the data configured in calls to 
    /// <see cref="ConfigureInitialRecords(ModelBuilder)"/>.
    /// </summary>
    internal static class ConfigurationExtensions
    {
        /// <summary>
        /// Gets the built-in instances of <see cref="BrokerTransactionCode"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static BrokerTransactionCode[] BrokerTransactionCodes { get; } =
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="BrokerTransactionCodeAttributeMemberEntry"/> 
        /// for development, test, and initial deployment.
        /// </summary>
        private static BrokerTransactionCodeAttributeMemberEntry[]
            BrokerTransactionCodeAttributes
        { get; } =
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="Country"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static Country[] Countries { get; } = new Country[]
        {
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="MarketHoliday"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static MarketHoliday[] MarketHolidays { get; } = new MarketHoliday[]
        {
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="MarketHolidayObservance"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static MarketHolidayObservance[] MarketHolidayObservances { get; } =
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="ModelAttribute"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static ModelAttribute[] ModelAttributes { get; } = new ModelAttribute[]
        {
            new()
            {
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="ModelAttributeMember"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static ModelAttributeMember[] ModelAttributeMembers { get; } = new ModelAttributeMember[]
        {
            // ASSET CLASS
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="ModelAttributeScope"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static ModelAttributeScope[] ModelAttributeScopes { get; } = ModelAttributes
                    .Where(a =>
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="SecurityType"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static SecurityType[] SecurityTypes { get; } = new SecurityType[]
            {
                new()
                {
                    SecurityTypeId = -300,
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="SecurityTypeGroup"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static SecurityTypeGroup[] SecurityTypeGroups { get; } = new SecurityTypeGroup[]
        {
        ...
        /// <summary>
        /// Gets the built-in instances of <see cref="SecuritySymbolType"/> for development, test, 
        /// and initial deployment.
        /// </summary>
        private static SecuritySymbolType[] SecuritySymbolTypes { get; } = new SecuritySymbolType[]
        {
        ...
        public static void ConfigureInitialRecords(this ModelBuilder modelBuilder)
        {
            modelBuilder
                .HasInitialRecords(BrokerTransactionCodes)
                .HasInitialRecords(BrokerTransactionCodeAttributes)
                .HasInitialRecords(Countries)
                .HasInitialRecords(MarketHolidays)
                .HasInitialRecords(MarketHolidayObservances)
                .HasInitialRecords(ModelAttributes)
                .HasInitialRecords(ModelAttributeScopes)
                .HasInitialRecords(ModelAttributeMembers)
                .HasInitialRecords(SecurityTypeGroups)
                .HasInitialRecords(SecurityTypes)
                .HasInitialRecords(SecuritySymbolTypes);
        }
        ...
        private static ModelBuilder HasInitialRecords<T>(
