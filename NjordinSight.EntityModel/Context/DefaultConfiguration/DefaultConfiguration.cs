...
{
    /// <summary>
    /// Defines a collection of records representing the initial state for all stages for the 
    /// application data store. Data definitions access via this interface are free of any dependency 
    /// and should be configured prior to appling any other custom configuration or 
    /// <see cref="IEntityTypeConfiguration{TEntity}"/> instances.
    /// </summary>
    /// <remarks>
    /// Implementers of this interface sshould define the initial state for the following:
    /// <list type="bullet">
    ...
    /// </list>
    /// </remarks>
    internal interface IDefaultConfiguration
    {
        /// <summary>
    ...
    /// <summary>
    /// Implements <see cref="IDefaultConfiguration"/>.
    /// </summary>
    internal class DefaultConfiguration : IDefaultConfiguration
    {
        public DefaultConfiguration()
        {
            ...
            ModelAttributeMembers = new ModelAttributeMember[]
            {
                // ASSET CLASS
        ...
        /// <inheritdoc/>
        public BrokerTransactionCode[] BrokerTransactionCodes { get; private init; }

        /// <inheritdoc/>
        public Country[] Countries { get; private init; }

        /// <inheritdoc/>
        public MarketHolidayObservance[] MarketHolidayObservances { get; private init; }

        /// <inheritdoc/>
        public MarketHoliday[] MarketHolidays { get; private init; }

        /// <inheritdoc/>
        public ModelAttributeMember[] ModelAttributeMembers { get; private init; }

        /// <inheritdoc/>
        public ModelAttribute[] ModelAttributes { get; private init; }

        /// <inheritdoc/>
        public ModelAttributeScope[] ModelAttributeScopes { get; private init; }

        /// <inheritdoc/>
        public SecuritySymbolType[] SecuritySymbolTypes { get; private init; }

        /// <inheritdoc/>
        public SecurityTypeGroup[] SecurityTypeGroups { get; private init; }

        /// <inheritdoc/>
        public SecurityType[] SecurityTypes { get; private init; }

        /// <inheritdoc/>
        public Security[] Securities { get; private init; }
    }
}
